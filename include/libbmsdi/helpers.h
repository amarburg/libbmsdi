...
HELPER_ONE_PARAM( ExposureOrdinal, BM_CAT_VIDEO, BM_PARAM_EXPOSURE_ORD, int16_t, BM_TYPE_INT16 )
...
#define BM_AUTOEXPOSURE_MANUAL 0
#define BM_AUTOEXPOSURE_IRIS 1
#define BM_AUTOEXPOSURE_SHUTTER 2
